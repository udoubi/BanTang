...
- (NSArray<ZLPhotoAblumList *> *)getPhotoAblumList
{
    ...
    [smartAlbums enumerateObjectsUsingBlock:^(PHAssetCollection * _Nonnull collection, NSUInteger idx, BOOL *stop) {
        ...
        if (!([collection.localizedTitle isEqualToString:@"Recently Deleted"] ||
            [collection.localizedTitle isEqualToString:@"Videos"] || [collection.localizedTitle isEqualToString:@"Bursts"] || [collection.localizedTitle isEqualToString:@"Selfies"] || [collection.localizedTitle isEqualToString:@"Recently Added"])) {
